...
const heroSlides = [
  {
    ...
    description: "Accept cards, bank transfers and Apple Pay from 180+ countries",
  ...
  {
    heading: "Global Business Banking",
    description: "Simplify collections, transfers and account workflows for growing teams",
    image: "/images/tallykonnect-hero-model.png",
    alt: "Business banking representative",
    badge: "BUSINESS BANKING",
  },
  {
    heading: "Smarter Cross-Border Payouts",
    description: "Send secure payouts worldwide with reliable tracking and control",
    image: "/images/hero-sectionimage.png",
    alt: "Cross-border payouts representative",
    badge: "GLOBAL PAYOUTS",
  },
  {
    heading: "Borderless Money Movement",
    description: "Move money faster with automated finance operations built for scale",
    image: "/images/hero-money-movement.png",
